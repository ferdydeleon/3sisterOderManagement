            ...
            <section class="mt-10">
                <form action="/order/customer" method="POST" class="flex flex-col">
                    ...
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        ...
                        <input id="quantity" type="number" name="quantity" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" value={{old('quantity')}} >
                        @error('quantity')
                        <p class="text-red-500 text-xs mt-2 p-1">
                            {{$message}}
                        </p>
                    ...
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        ...
                        <select  id="payment"  name="payment" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3">
                    ...
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        ...
                        <input  type="number" name="deliver_charge" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" value="0" >
                    ...
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        ...
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Customer Notes..."  value=""></textarea>
