    ...
    <section x-data="{ open: false }" class="mt-10">
        <form action="/login/process" method="POST" class="flex flex-col">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input placeholder="input here" type="email" name="email"
                    class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input placeholder="input here" type="password" name="password"
                    class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" />
            </div>

            <button
                class="bg-pink-600 hover:bg-pink-700 text-bold text-white py-2 rounded shadow-lg
                        hover:shadow-xl transition duration-200"
                type="submit" x-on:click="open = !open">
                <svg x-show="open" x-transition aria-hidden="true" role="status"
